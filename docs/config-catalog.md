...
Requires: `tools` · `agents` · `systemPrompt` · `storageDomain` · `jobs` · `subagents`
...
Source: [`packages/experimental/security-analysis/src/index.ts:27`](../packages/experimental/security-analysis/src/index.ts)
...
- `@deepseek-ai/dsh-experimental-security-profile` — requires `loader` · `sessionProjections` ([`packages/experimental/security-profile/src/index.ts`](../packages/experimental/security-profile/src/index.ts))
