...
| [`security-analysis`](security-analysis/README.md) | Reverse checks, evidence, plan approval and provider interfaces | `ctx.securityWorkbench` |
| [`security-profile`](security-profile/README.md) | Optional Host composition with guarded security tools | — |
| [`security-web-profile`](security-web-profile/README.md) | Optional Web workbench composition | — |
| [`client-ui-security-analysis`](client-ui-security-analysis/README.md) | Project, evidence, environment and validation controls | — |
